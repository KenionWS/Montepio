...
<div class="box">
  <div class="logo">
    <img src="<?= BASE_URL ?>/assets/brand/montepio-logo.jpg" alt="Montepio Antiguedades" class="logo-image"><div class="logo-text"><div class="sub">Configuracion inicial</div></div>
  </div>
