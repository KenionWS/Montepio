...
try {
    ...
    error_log('Error eliminando producto(s): ' . $e->getMessage());
    flash_set('err', 'No se pudo eliminar. Revisar permisos o el log del servidor.');
}

$redirect = (string)($_POST['redirect'] ?? '');
if ($redirect === '' || substr($redirect, 0, strlen(ADMIN_URL . '/')) !== ADMIN_URL . '/') {
