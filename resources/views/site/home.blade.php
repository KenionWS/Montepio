        ...
        <div class="map-wrapper">
            <div class="map-info">
                ...
                <div class="map-contact-item">
                    ...
                    <div><strong>Direccion</strong>Av. Rivadavia 7701, Flores<br>Ciudad de Buenos Aires</div>
                </div>
                <div class="map-contact-item">
                    <div class="icon-box">
                ...
                <div class="map-contact-item">
                    <div class="icon-box">
                        <svg width="18" height="18" fill="none" stroke="white" stroke-width="2" viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                    </div>
                    <div><strong>Email</strong><a href="mailto:montepioantiguedades@gmail.com">montepioantiguedades@gmail.com</a></div>
                </div>
                <div class="map-contact-item">
                    <div class="icon-box">
                        <svg width="18" height="18" fill="white" viewBox="0 0 24 24"><path d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2m8.5 1.8h-8.5A3.95 3.95 0 0 0 3.8 7.75v8.5a3.95 3.95 0 0 0 3.95 3.95h8.5a3.95 3.95 0 0 0 3.95-3.95v-8.5a3.95 3.95 0 0 0-3.95-3.95M17.6 6.4a1.05 1.05 0 1 1 0 2.1 1.05 1.05 0 0 1 0-2.1M12 7a5 5 0 1 1 0 10 5 5 0 0 1 0-10m0 1.8A3.2 3.2 0 1 0 12 15.2 3.2 3.2 0 0 0 12 8.8"/></svg>
                    </div>
