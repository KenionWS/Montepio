<div class="topbar">
    <div class="topbar-inner">
        <div class="topbar-group">
            <span class="topbar-item topbar-icon-item"><svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.8 19.8 0 01-8.63-3.07 19.5 19.5 0 01-6-6A19.8 19.8 0 012.18 4.18 2 2 0 014.16 2h3a2 2 0 012 1.72c.12.9.33 1.77.64 2.6a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.48-1.26a2 2 0 012.11-.45c.83.31 1.7.52 2.6.64A2 2 0 0122 16.92z"></path></svg>4612-1221 / 4612-8787</span>
            <span class="topbar-item topbar-icon-item"><svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.8 19.8 0 01-8.63-3.07 19.5 19.5 0 01-6-6A19.8 19.8 0 012.18 4.18 2 2 0 014.16 2h3a2 2 0 012 1.72c.12.9.33 1.77.64 2.6a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.48-1.26a2 2 0 012.11-.45c.83.31 1.7.52 2.6.64A2 2 0 0122 16.92z"></path></svg>116571-4568</span>
        </div>
        <div class="topbar-group">
            <span class="topbar-item topbar-icon-item"><svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>Av. Rivadavia 7701, CABA</span>
